...
def get_data(url)->list:
    ...
    trees_cats = driver.find_elements(By.XPATH,'//*[@class="collection-thumb-link"]')
    stop_point = len(trees_cats)
...
#    time.sleep(2)
    ...
    #data = 
def main():
    data = get_data("https://www.treesofantiquity.com/")
